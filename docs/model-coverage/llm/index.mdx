...
| ZAI / Zhipu AI | [GLM-5 / GLM-5.1 / GLM-5.2](/model-coverage/large-language-models/glm-5-moe-dsa) | `GlmMoeDsaForCausalLM` |
...
| Poolside | [Laguna](/model-coverage/large-language-models/laguna) | `LagunaForCausalLM` |
